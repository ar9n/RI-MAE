...
from tools import RIMAE_pretrain_test_net as pretrain_test
from tools import RIMAE_finetune_test_net as finetune_test
...
def main():
    ...
    if args.distributed:
        ...
        config.dataset.val.others.bs = config.total_bs * 1
        if config.dataset.get('test'):
